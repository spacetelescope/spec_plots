...
set files = ( "make_hst_spec_previews.py" "make_html.py" "utils/specutils/dq_has_flag.py" "utils/specutils/rms.py" "utils/specutils/stitch_components.py" "utils/specutils/avoidregion.py" "utils/specutils/edge_trim.py" "utils/specutils/set_plot_xrange.py" "utils/specutils/calc_plot_metrics.py" "utils/specutils/calc_plot_transparency.py" "utils/specutils/get_flux_stats.py" "utils/specutils/set_plot_yrange.py" "utils/specutils/debug_oplot.py" "utils/specutils/is_bad_dq.py" "utils/specutils/specutilserror.py" "utils/specutils_cos/extract_subspec.py" "utils/specutils_cos/readspec.py" "utils/specutils_cos/check_segments.py" "utils/specutils_cos/get_segment_names.py" "utils/specutils_cos/cosspectrum.py" "utils/specutils_cos/plotspec.py" "utils/specutils_stis/plotspec.py" "utils/specutils_stis/stis1dspectrum.py" "utils/specutils_stis/get_association_indices.py" "utils/specutils_stis/readspec.py" )
